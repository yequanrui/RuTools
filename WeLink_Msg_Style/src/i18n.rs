...
pub fn get_by_lang(key: &str) -> String {
    let res = match key {
        ...
        // 操作提示
        "example" => ["Example", "示例"],
        "msg_style_enabled" => ["Message Style Enabled.", "显眼包已启用"],
        "msg_style_disabled" => ["Message Style Disabled.", "显眼包已停用"],
        "modify_msg_style" => ["Modify Message Style", "自定义消息样式"],
        ...
        "current_blacklist_total" => ["Current total of blacklist", "当前黑名单个数"],
